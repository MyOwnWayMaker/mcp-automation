...
import { xactListAssignments, xactGetAssignment, xactUpdateDates, xactUpdateWorkflowStatus, xactAddNote, xactGetNotes, xactFindAssignmentByClaim } from "./tools/xactanalysis.js";
...
const TOOLS: Tool[] = [
  ...
  { name: "xact_find_assignment_by_claim", description: "Find a XactAnalysis assignment by carrier claim number (e.g. '12-1226000034'). Returns the MFN code needed for other xact_* tools. Searches all available assignments.", inputSchema: { type: "object", properties: { claim_number: { type: "string", description: "Carrier claim number to search for (partial match supported)" } }, required: ["claim_number"] } },
