...
const TOOLS: Tool[] = [
  ...
  { name: "xact_set_planned_inspection_date", description: "Set the Planned Inspection Date on an XA assignment. Separate UI element from updateStatus — this targets the specific Planned Inspection Date input.", inputSchema: { type: "object", properties: { mfn: { type: "string" }, date: { type: "string", description: "YYYY-MM-DD or M/D/YYYY" } }, required: ["mfn", "date"] } },
